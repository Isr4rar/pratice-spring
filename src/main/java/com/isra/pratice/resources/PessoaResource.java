package com.isra.pratice.resources;
...
import com.isra.pratice.services.PessoaService;
...
public class PessoaResource {
	...
	public ResponseEntity<List<PessoaDTO>> findAll(){
		...
		List<PessoaDTO> listDtos = list.stream().map(obj -> new PessoaDTO(obj)).collect(Collectors.toList());
